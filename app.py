...
def migrate_db():
    try:
        ...
        if children_count < 55:
            ...
            default_children = [
                ('리야', None, '여', '/static/uploads/child_48_리야.jpg', '모름', '초5\n\n🙏 기도제목: 안톤 같은 반 친구가 자꾸 밀고 괴롭혀요.', '010-8294-3133', '키르기스스탄', '중', '출석명단, 기도제목'),
                ('로만', None, '여', '/static/uploads/child_49_로만.jpg', '모름', '초3\n\n🙏 기도제목: 타이타닉 타고 싶어요.', '010-8294-3133', '키르기스스탄', '중', '출석명단, 기도제목'),
                ('밀라나', None, '여', '/static/uploads/child_33_밀라나.jpg', '모름', '초6\n\n🙏 기도제목: 토요일 부모님이 막내를 돌봐줘서 예배에 나오도록, 가족건강', '010-8104-0911', '러시아', '상', '출석명단, 기도제목'),
                ('유노나', None, '여', '/static/uploads/child_34_유노나.jpg', '모름', '초2\n\n🙏 기도제목: 하나님, 공부 잘하게 해 주세요.', '010-6597-2014', '러시아', '중', '출석명단, 기도제목'),
                ('넬리', None, '여', '/static/uploads/child_50_넬리.jpg', '모름', '초5\n\n🙏 기도제목: 다른 교회 다님, 캠프에만 참여', '010-8338-1704', '카자흐스탄', '중', '출석명단, 기도제목'),
                ('욜라', None, '여', '/static/uploads/child_51_욜라.jpg', '모름', '초2\n\n🙏 기도제목: 다른 교회 다님, 캠프에만 참여', '010-8338-1704', '카자흐스탄', '', '출석명단, 기도제목'),
                ('허 베라', None, '여', '/static/uploads/child_52_허베라.jpg', '모름', '초5\n\n🙏 기도제목: 엄마, 아빠 건강을 위하여', '010-3234-2551', '우크라이나', '중', '출석명단, 기도제목'),
                ('김 안나', None, '여', '/static/uploads/child_35_김안나.jpg', '모름', '초6\n\n🙏 기도제목: 하나님, 항상 도와 주셔서 감사합니다.', '010-2187-0167', '러시아', '중', '출석명단, 기도제목'),
                ('리디야', None, '여', '/static/uploads/child_36_리디야.jpg', '모름', '초4\n\n🙏 기도제목: 다친 팔이 빨리 회복되게 해주세요.', '010-8028-1495', '러시아', '중', '출석명단, 기도제목'),
                ('캐롤리나', None, '여', '/static/uploads/child_37_캐롤리나.jpg', '모름', '초3\n\n🙏 기도제목: 하나님을 끝까지 사랑해 주세요.', '010-4244-1705', '카자흐스탄', '', '출석명단, 기도제목'),
                ('루슬란', None, '여', None, '모름', '초4\n\n🙏 기도제목: 예배에 규칙적으로 잘 나오도록', '010-8414-7343', '카자흐스탄', '상', '출석명단, 기도제목'),
                ('올레그', None, '여', None, '모름', '초3\n\n🙏 기도제목: 한국어 습득이 성장하도록', '', '카자흐스탄', '', '출석명단, 기도제목'),
                ('콘스탄틴', None, '여', '/static/uploads/child_53_콘스탄틴.jpg', '모름', '초5\n\n🙏 기도제목: 한국어 공부와 수학 이해력을 위하여', '010-5801-0831', '러시아', '중', '출석명단, 기도제목'),
                ('황 니키타', None, '여', None, '모름', '중1\n\n🙏 기도제목: 이사한 곳에서 잘 적응하도록', '010-5741-7757', '카자흐스탄', '중', '출석명단, 기도제목'),
                ('바넷사', None, '여', '/static/uploads/child_38_신바넷사.jpg', '모름', '초4\n\n🙏 기도제목: 부모님 말씀 더 잘 듣고 우리 가족이 잘 살게 해주세요.', '010-3911-1225', '우즈베키스탄', '', '출석명단, 기도제목'),
                ('로베르트', None, '여', '/static/uploads/child_39_신로베르트.jpg', '모름', '초1\n\n🙏 기도제목: 공부를 하고싶어요', '010-3911-1225', '우즈벡(한국)', '', '출석명단, 기도제목'),
                ('박 니키타', None, '여', '/static/uploads/child_40_박니키타.jpg', '모름', '초6\n\n🙏 기도제목: 의사의 비전을 가지게 되었어요.', '010-5657-8486', '러시아(한국)', '중', '출석명단, 기도제목'),
                ('박 베로니카', None, '여', '/static/uploads/child_47_박베로니카.jpg', '모름', '둔포중2\n\n🙏 기도제목: 기말 시험 잘 준비하도록', '010-5657-8486', '러시아', '상', '출석명단, 기도제목'),
                ('밀라나', None, '여', '/static/uploads/child_33_밀라나.jpg', '모름', '중2', '010-5596-8600', '카자흐스타', '', '출석명단'),
                ('마샤(마리아)', None, '여', '/static/uploads/child_41_마샤(마리아).jpg', '모름', '초5\n\n🙏 기도제목: 독일, 아메리카 여행을 하도록', '010-82434-2102', '우즈베키스탄', '중', '출석명단, 기도제목'),
                ('슬라바', None, '여', '/static/uploads/child_44_슬라바.jpg', '모름', '중1\n\n🙏 기도제목: 시험에 100점을 받고 싶어요.', '010-6465-5352', '카자흐스탄', '상', '출석명단, 기도제목'),
                ('채 빅토르', None, '여', '/static/uploads/child_45_채빅토르.jpg', '모름', '테크노 중2\n\n🙏 기도제목: 음식 (요리 제빵사)의 꿈을 위하여', '010-5946-8538', '카자흐스탄', '상', '출석명단, 기도제목'),
                ('밀레나', None, '여', '/static/uploads/child_54_밀레나.jpg', '모름', '초5\n\n🙏 기도제목: 지속적으로 예배에 나오도록', '010-6606-5590', '우크라이나', '중', '출석명단, 기도제목'),
                ('벡술탄', None, '여', None, '모름', '', '010-2748-4443', '카자흐스탄', '중', '출석명단'),
                ('안 안나', None, '여', '/static/uploads/child_42_안안나.jpg', '모름', '초6\n\n🙏 기도제목: 건강을 위하여', '010-2225-8425', '우즈베키스탄', '중', '출석명단, 기도제목'),
                ('폴리나', None, '여', '/static/uploads/child_55_폴리나.jpg', '모름', '초4\n\n🙏 기도제목: 공부 잘하고 숙제를 잘하고 싶어요, 엄마와 동생 건강', '010-2865-1612', '러시아', '', '출석명단, 기도제목'),
                ('이 예바', None, '여', None, '모름', '초6\n\n🙏 기도제목: 한국어 공부와 엄마를 위하요', '010-8210-3882', '', '중', '출석명단, 기도제목'),
                ('비올레타', None, '여', '/static/uploads/child_57_비올레타.jpg', '모름', '초6\n\n🙏 기도제목: 사춘기 과정을 잘 지내도록', '010-8365-7504', '우즈베키스탄', '중', '출석명단, 기도제목'),
                ('김크세니아', None, '여', None, '모름', '초6\n\n🙏 기도제목: 예배에 나오도록', '010-9546-2034', '러시아', '', '출석명단, 기도제목'),
                ('크세니아', None, '여', '/static/uploads/child_58_크세니아.jpg', '모름', '', '010-2392-0114', '카자흐스탄', '', '출석명단'),
                ('카밀라', None, '여', '/static/uploads/child_46_카밀라.jpg', '모름', '중2\n\n🙏 기도제목: 시험 잘 준비하여 좋은 결과 나오도록', '010-8407-1712', '러시아', '', '출석명단, 기도제목'),
                ('제냐', None, '여', None, '모름', '초4\n\n🙏 기도제목: 3월부터 안 나옴', '010-5875-1509', '카자흐스탄', '', '출석명단, 장기결석, 기도제목'),
                ('에릭', None, '여', None, '모름', '초4\n\n🙏 기도제목: 3월부터 안 나옴', '010-9980-3066', '카자흐스탄', '', '출석명단, 기도제목'),
                ('데니스', None, '여', None, '모름', '초5\n\n🙏 기도제목: 3월부터 안 나옴', '010-8280-3903', '카자흐스탄', '', '출석명단, 기도제목'),
                ('알란', None, '여', None, '모름', '초4\n\n🙏 기도제목: 3월부터 안 나옴', '010-8322-7343', '카자흐스탄', '', '출석명단, 기도제목'),
                ('리엔', None, '여', '/static/uploads/child_60_리엔.jpg', '모름', '초6\n\n🙏 기도제목: 1월부터 안 나옴', '010-2187-8098', '', '', '출석명단, 기도제목'),
                ('김안나', None, '여', '/static/uploads/child_35_김안나.jpg', '모름', '초4\n\n🙏 기도제목: 3월부터 안 나옴', '010-7515-8067', '카자흐스탄', '', '출석명단, 기도제목'),
                ('카리나', None, '여', '/static/uploads/child_43_카리나.jpg', '모름', '초5\n\n🙏 기도제목: U.S.A 여행을 위하여 (희망)', '010-8113-2908', '', '', '출석명단, 기도제목'),
                ('샤샤', None, '여', '/static/uploads/child_59_샤샤.jpg', '모름', '초5\n\n🙏 기도제목: 돈, 운동', '010-8497-2308', '카자흐스탄', '', '출석명단, 기도제목'),
                ('손 올레샤', None, '여', None, '모름', '초5\n\n🙏 기도제목: 3월부터 안 나옴', '010-8380-6090', '러시아', '', '출석명단, 기도제목'),
                ('최 아나스타샤', None, '여', None, '모름', '초5\n\n🙏 기도제목: 3월부터 안 나옴', '010-6876-9960', '러시아', '', '출석명단, 기도제목'),
                ('샤샤', None, '여', '/static/uploads/child_59_샤샤.jpg', '모름', '초6', '010-5937-7343', '', '', '출석명단, 장기결석'),
                ('빅토리아', None, '여', None, '모름', '', '010-7587-4661', '', '', '장기결석'),
                ('다이아나', None, '여', None, '모름', '', '010-2754-6366', '', '', '장기결석'),
                ('예다슬', None, '여', None, '모름', '', '010-9103-7886', '', '', '장기결석'),
                ('한 알엑산들', None, '여', None, '모름', '', '010-8291-1933', '', '', '장기결석'),
                ('도미니크', None, '여', None, '모름', '', '-', '', '', '장기결석'),
                ('김 거스댜', None, '여', None, '모름', '', '010-2245-4308', '', '', '장기결석'),
                ('김 막심', None, '여', None, '모름', '', '010-2352-2607', '', '', '장기결석'),
                ('아델리나', None, '여', None, '모름', '', '010-9891-0586', '', '', '장기결석'),
                ('막심', None, '여', None, '모름', '', '-', '', '', '장기결석'),
                ('아르투르', None, '여', None, '모름', '', '010-5502-1600', '', '', '장기결석'),
                ('미카에', None, '여', None, '모름', '', '010-2818-7308', '', '', '장기결석'),
                ('스파스', None, '여', None, '모름', '', '', '', '', '장기결석'),
                ('티무르', None, '여', None, '모름', '', '', '', '', '장기결석'),
                ('티모피', None, '여', None, '모름', '초6', '010-4638-3742', '', '', '장기결석'),
                ('소피아', None, '여', None, '모름', '', '010-8059-5723', '', '', '장기결석'),
                ('아나스타샤', None, '여', None, '모름', '', '-', '', '', '장기결석'),
                ('알렉세이', None, '여', None, '모름', '', '010-6529-1407', '', '', '장기결석'),
                ('마트베이', None, '여', None, '모름', '', '010-4462-2592', '', '', '장기결석'),
                ('비카', None, '여', None, '모름', '초4\n\n🙏 기도제목: 친구를 도와주는 비카가 되고, 가족을 위하여', '', '', '', '기도제목'),
                ('다비드', None, '여', None, '모름', '초2\n\n🙏 기도제목: 나도 공부를 잘하고 싶어요, 한국어 공부', '', '', '', '기도제목'),
                ('다니엘', None, '여', None, '모름', '중 1\n\n🙏 기도제목: 하나님의 자비를 위하여', '', '', '', '기도제목'),
            ]
            cursor.executemany("""
...
def target_children_add():
    ...
    execute_db("""
        INSERT INTO target_children (name, age, gender, photo_path, parents_church, notes, phone, nationality, korean_level, source_sheet)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, (name, age, gender, photo_path, parents_church, notes, phone, nationality, korean_level, source_sheet))
...
def target_children_edit(id):
    ...
    execute_db("""
        ...
        SET name = ?, age = ?, gender = ?, photo_path = ?, parents_church = ?, notes = ?, phone = ?, nationality = ?, korean_level = ?, source_sheet = ?
        WHERE id = ?
    """, (name, age, gender, photo_path, parents_church, notes, phone, nationality, korean_level, source_sheet, id))
