    ...
    try:
        ...
        if children_count < 55:
            ...
            default_children = [
                ...
                ('루슬란', '초4', '여', None, '모름', '🙏 기도제목: 예배에 규칙적으로 잘 나오도록', '010-8414-7343', '카자흐스탄', '상', '출석명단, 기도제목'),
                ('올레그', '초3', '여', None, '모름', '🙏 기도제목: 한국어 습득이 성장하도록', '', '카자흐스탄', '', '출석명단, 기도제목'),
                ('콘스탄틴', '초5', '여', '/static/uploads/child_53_콘스탄틴.jpg', '모름', '🙏 기도제목: 한국어 공부와 수학 이해력을 위하여', '010-5801-0831', '러시아', '중', '출석명단, 기도제목'),
                ('황 니키타', '중1', '여', None, '모름', '🙏 기도제목: 이사한 곳에서 잘 적응하도록', '010-5741-7757', '카자흐스탄', '중', '출석명단, 기도제목'),
                ...
                ('벡술탄', '', '여', None, '모름', '', '010-2748-4443', '카자흐스탄', '중', '출석명단'),
                ...
                ('에릭', '초4', '여', None, '모름', '🙏 기도제목: 3월부터 안 나옴', '010-9980-3066', '카자흐스탄', '', '출석명단, 기도제목'),
                ('데니스', '초5', '여', None, '모름', '🙏 기도제목: 3월부터 안 나옴', '010-8280-3903', '카자흐스탄', '', '출석명단, 기도제목'),
                ('알란', '초4', '여', None, '모름', '🙏 기도제목: 3월부터 안 나옴', '010-8322-7343', '카자흐스탄', '', '출석명단, 기도제목'),
                ...
                ('샤샤', '초6', '여', None, '모름', '', '010-5937-7343', '', '', '출석명단, 장기결석'),
                ('빅토리아', '', '여', None, '모름', '', '010-7587-4661', '', '', '장기결석'),
                ('다이아나', '', '여', None, '모름', '', '010-2754-6366', '', '', '장기결석'),
                ('예다슬', '', '여', None, '모름', '', '010-9103-7886', '', '', '장기결석'),
                ('한 알엑산들', '', '여', None, '모름', '', '010-8291-1933', '', '', '장기결석'),
                ('도미니크', '', '여', None, '모름', '', '-', '', '', '장기결석'),
                ('김 거스댜', '', '여', None, '모름', '', '010-2245-4308', '', '', '장기결석'),
                ('김 막심', '', '여', None, '모름', '', '010-2352-2607', '', '', '장기결석'),
                ('아델리나', '', '여', None, '모름', '', '010-9891-0586', '', '', '장기결석'),
                ('막심', '', '여', None, '모름', '', '-', '', '', '장기결석'),
                ('아르투르', '', '여', None, '모름', '', '010-5502-1600', '', '', '장기결석'),
                ('미카에', '', '여', None, '모름', '', '010-2818-7308', '', '', '장기결석'),
                ('스파스', '', '여', None, '모름', '', '', '', '', '장기결석'),
                ('티무르', '', '여', None, '모름', '', '', '', '', '장기결석'),
                ('티모피', '초6', '여', None, '모름', '', '010-4638-3742', '', '', '장기결석'),
                ('소피아', '', '여', None, '모름', '', '010-8059-5723', '', '', '장기결석'),
                ('아나스타샤', '', '여', None, '모름', '', '-', '', '', '장기결석'),
                ('알렉세이', '', '여', None, '모름', '', '010-6529-1407', '', '', '장기결석'),
                ('마트베이', '', '여', None, '모름', '', '010-4462-2592', '', '', '장기결석'),
                ('비카', '초4', '여', None, '모름', '🙏 기도제목: 친구를 도와주는 비카가 되고, 가족을 위하여', '', '', '', '기도제목'),
                ('다비드', '초2', '여', None, '모름', '🙏 기도제목: 나도 공부를 잘하고 싶어요, 한국어 공부', '', '', '', '기도제목'),
