...
def migrate_db():
    try:
        ...
        if children_count == 0:
            default_children = [
                ("밀라나", 13, "여", "/static/uploads/child_33_밀라나.jpg", "모름", "초 6\n\n🙏 기도제목: 토요일 부모님이 막내를 돌봐줘서 예배에 나오도록, 가족건강", "010-5596-8600"),
                ("유노나", 9, "여", "/static/uploads/child_34_유노나.jpg", "모름", "초 2\n\n🙏 기도제목: 하나님, 공부 잘하게 해 주세요.", "010-6597-2014"),
                ("김 안나", 13, "여", "/static/uploads/child_35_김안나.jpg", "모름", "초 6\n\n🙏 기도제목: 3월부터 안 나옴", "010-7515-8067"),
                ("리디야", 11, "여", "/static/uploads/child_36_리디야.jpg", "모름", "초 4\n\n🙏 기도제목: 다친 팔이 빨리 회복되게 해주세요.", "010-8028-1495"),
                ("캐롤리나", 10, "여", "/static/uploads/child_37_캐롤리나.jpg", "모름", "초 3\n\n🙏 기도제목: 하나님을 끝까지 사랑해 주세요. ", "010-4244-1705"),
                ("신 바넷사", 11, "여", "/static/uploads/child_38_신바넷사.jpg", "모름", "초 4\n\n🙏 기도제목: 부모님 말씀 더 잘 듣고 우리 가족이 잘 살게 해주세요.", "010-3911-1225"),
                ("신 로베르트", 8, "여", "/static/uploads/child_39_신로베르트.jpg", "모름", "초 1\n\n🙏 기도제목: 공부를 하고싶어요", "010-3911-1225"),
                ("박 니키타", 13, "여", "/static/uploads/child_40_박니키타.jpg", "모름", "초 6\n\n🙏 기도제목: 의사의 비전을 가지게 되었어요.", "010-5657-8486"),
                ("마샤(마리아)", 12, "여", "/static/uploads/child_41_마샤(마리아).jpg", "모름", "초 5\n\n🙏 기도제목: 독일, 아메리카 여행을 하도록", "010-82434-2102"),
                ("안 안나", 13, "여", "/static/uploads/child_42_안안나.jpg", "모름", "초 6\n\n🙏 기도제목: 건강을 위하여", "010-2225-8425"),
                ("카리나", 12, "여", "/static/uploads/child_43_카리나.jpg", "모름", "초 5\n\n🙏 기도제목: U.S.A 여행을 위하여 (희망)", "010-8113-2908"),
                ("슬라바", 14, "여", "/static/uploads/child_44_슬라바.jpg", "모름", "중 1\n\n🙏 기도제목: 시험에 100점을 받고 싶어요.", "010-6465-5352"),
                ("채 빅토르", 15, "여", "/static/uploads/child_45_채빅토르.jpg", "모름", "중 2\n\n🙏 기도제목: 음식 (요리 제빵사)의 꿈을 위하여", "010-5946-8538"),
                ("카밀라", 15, "여", "/static/uploads/child_46_카밀라.jpg", "모름", "중 2\n\n🙏 기도제목: 시험 잘 준비하여 좋은 결과 나오도록", "010-8407-1712"),
                ("박 베로니카", 15, "여", "/static/uploads/child_47_박베로니카.jpg", "모름", "둔포중 2\n\n🙏 기도제목: 기말 시험 잘 준비하도록", "010-5657-8486"),
                ("리야", 12, "여", "/static/uploads/child_48_리야.jpg", "모름", "초 5\n\n🙏 기도제목: 안톤 같은 반 친구가 자꾸 밀고 괴롭혀요.", "010-8294-3133"),
                ("로만", 9, "여", "/static/uploads/child_49_로만.jpg", "모름", "초 2\n\n🙏 기도제목: 타이타닉 타고 싶어요.", "010-8294-3133"),
                ("넬리", 12, "여", "/static/uploads/child_50_넬리.jpg", "모름", "초 5\n\n🙏 기도제목: 다른 교회 다님, 캠프에만 참여", "010-8338-1704"),
                ("욜라", 9, "여", "/static/uploads/child_51_욜라.jpg", "모름", "초 2\n\n🙏 기도제목: 다른 교회 다님, 캠프에만 참여", "010-8338-1704"),
                ("허 베라", 12, "여", "/static/uploads/child_52_허베라.jpg", "모름", "초 5\n\n🙏 기도제목: 엄마, 아빠 건강을 위하여", "010-3234-2551"),
                ("콘스탄틴", 12, "여", "/static/uploads/child_53_콘스탄틴.jpg", "모름", "초 5\n\n🙏 기도제목: 한국어 공부와 수학 이해력을 위하여", "010-5801-0831"),
                ("밀레나", 12, "여", "/static/uploads/child_54_밀레나.jpg", "모름", "초 5\n\n🙏 기도제목: 지속적으로 예배에 나오도록", "010-6606-5590"),
                ("폴리나", 13, "여", "/static/uploads/child_55_폴리나.jpg", "모름", "초 6\n\n🙏 기도제목: 공부 잘하고 숙제를 잘하고 싶어요, 엄마와 동생 건강", "010-2865-1612"),
                ("예바", 13, "여", "/static/uploads/child_56_예바.jpg", "모름", "초 6\n\n🙏 기도제목: 한국어 공부와 엄마를 위하요", "010-8210-3882"),
                ("비올레타", 13, "여", "/static/uploads/child_57_비올레타.jpg", "모름", "초 6\n\n🙏 기도제목: 사춘기 과정을 잘 지내도록", "010-8365-7504"),
                ("크세니아", 13, "여", "/static/uploads/child_58_크세니아.jpg", "모름", "초 6\n\n🙏 기도제목: 예배에 나오도록", "010-9546-2034"),
                ("샤샤", 14, "여", "/static/uploads/child_59_샤샤.jpg", "모름", "중 1\n\n🙏 기도제목: 돈, 운동", "010-5937-7343"),
                ("리엔", 13, "여", "/static/uploads/child_60_리엔.jpg", "모름", "초 6\n\n🙏 기도제목: 1월부터 안 나옴", "010-2187-8098"),
                ("비카", 11, "여", None, "모름", "초 4\n\n🙏 기도제목: 친구를 도와주는 비카가 되고, 가족을 위하여", None),
                ("황 니키타", 15, "여", None, "모름", "중 2\n\n🙏 기도제목: 이사한 곳에서 잘 적응하도록", "010-5741-7757")
            ]
            cursor.executemany("""
